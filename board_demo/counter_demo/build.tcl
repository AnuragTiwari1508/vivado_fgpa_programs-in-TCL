# ============================================================
# build.tcl - Independent Vivado build script for board demo: counter_demo
...
set proj_name  "counter_demo_proj"
set proj_dir   [file join $origin_dir "vivado_proj"]
set part       "xc7s50csga324-1"
set top        "counter_demo_top"
...
puts "INFO: running synthesis for counter_demo"
reset_run synth_1
launch_runs synth_1 -jobs 4
wait_on_run synth_1
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "ERROR: synthesis failed for counter_demo"
}

puts "INFO: running implementation for counter_demo"
reset_run impl_1
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1
if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    error "ERROR: implementation/bitstream failed for counter_demo"
}
...
puts "DONE: counter_demo synthesis+implementation+bitstream complete."
