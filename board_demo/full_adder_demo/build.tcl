# ============================================================
# build.tcl - Independent Vivado build script for board demo: full_adder_demo
...
set proj_name  "full_adder_demo_proj"
set proj_dir   [file join $origin_dir "vivado_proj"]
set part       "xc7s50csga324-1"
set top        "full_adder_demo_top"
...
puts "INFO: running synthesis for full_adder_demo"
reset_run synth_1
launch_runs synth_1 -jobs 4
wait_on_run synth_1
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "ERROR: synthesis failed for full_adder_demo"
}

puts "INFO: running implementation for full_adder_demo"
reset_run impl_1
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1
if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    error "ERROR: implementation/bitstream failed for full_adder_demo"
}
...
puts "DONE: full_adder_demo synthesis+implementation+bitstream complete."
