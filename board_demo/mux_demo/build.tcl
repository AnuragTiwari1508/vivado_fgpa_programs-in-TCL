# ============================================================
# build.tcl - Independent Vivado build script for board demo: mux_demo
...
puts "INFO: running synthesis for mux_demo"
reset_run synth_1
launch_runs synth_1 -jobs 4
wait_on_run synth_1
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "ERROR: synthesis failed for mux_demo"
}

puts "INFO: running implementation for mux_demo"
reset_run impl_1
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1
if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    error "ERROR: implementation/bitstream failed for mux_demo"
}
...
puts "DONE: mux_demo synthesis+implementation+bitstream complete."
